...
import { normalizeValue, composeFullName } from "../intake/normalize";
...
export async function applyIntake({ rows = [], decisions = {}, identity = {} } = {}) {
  try {
    ...
    const { data, error } = await supabase.rpc("intake_apply", {
