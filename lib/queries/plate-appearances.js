...
const PA_COLUMNS =
  "id, game_id, player_id, pa_number, batting_order, inning, qab_reasons, is_qab, notes, " +
  "recorded_by, created_at, updated_at, voided_at, voided_by, " +
  // The batter's name travels with the row so a player who has been
  // substituted out can still be named. The lineup holds only who is
  // CURRENTLY due to bat, so after a substitution it no longer describes
  // everyone who batted in this game.
