...
/**
 * Which fields still need filling in. Derived, never stored.
 *
 * Requirements depend on person type: a coach has no jersey number or
 * fielding position, so demanding them would flag every staff member.
 */
