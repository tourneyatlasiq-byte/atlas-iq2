    ...
    tasks: [
      {
        ...
        direct: true,
        keywords: "facility venue field park complex where playing directions address",
      },
      {
        id: "facility-notes",
        title: "Save facility notes",
        text: "Open a facility, then add parking and gate notes.",
        href: "/facilities",
      ...
      },
      {
        ...
        text: "The facility isn't in Season Tempo yet.",
        href: "/facilities?add=1",
        cta: "Add facility",
        direct: true,
        keywords: "new facility venue missing not listed create park",
      },
      {
        id: "upload-document",
        ...
        cta: "Upload file",
        direct: true,
        keywords: "waiver insurance schedule roster form pdf photo paperwork document",
      },
    ],
  },
  {
    ...
    tasks: [
      ...
      {
        id: "invite",
        title: "Invite someone to Season Tempo",
